...
const buttonVariants = cva(
  "inline-flex min-w-0 items-center justify-center gap-2 whitespace-normal rounded-md text-center text-sm font-medium ring-offset-background transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outlineinfo:
          "border border-info bg-transparent text-info hover:bg-info hover:text-white",
        outlineerror:
        ...
        ghostsecondary:
          "text-secondary hover:bg-lightsecondary hover:text-secondary",
      ...
      size: {
        ...
        lg: "min-h-10 rounded-md px-7 py-2.5",
        icon: "h-9 w-9",
      },
      shape: {
        pill: "rounded-full",
