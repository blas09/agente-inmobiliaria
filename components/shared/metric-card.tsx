...
type MetricTone = "primary" | "secondary" | "success" | "warning" | "info" | "error";
...
export function MetricCard({
	...
	return (
		<div
			className={cn(
				"flex min-h-[9.5rem] flex-col items-center justify-center gap-3 rounded-md px-4 py-5 text-center",
				styles.card,
				className,
			)}
		>
			...
			<p className={cn("text-[2.05rem] leading-none font-semibold tracking-tight", styles.text, valueClassName)}>
				{value}
			</p>
		</div>
	);
