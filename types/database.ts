...
export type AppointmentStatus =
	...
	| "canceled"
	| "no_show";
export type ConversationStatus = "open" | "pending_human" | "automated" | "closed";
	...
	public: {
		Tables: {
			...
			channel_whatsapp_accounts: {
				...
				Update: Partial<Database["public"]["Tables"]["channel_whatsapp_accounts"]["Insert"]>;
				Relationships: [];
			};
			properties: {
				Row: {
			...
			channel_events: {
				...
				Update: Partial<Database["public"]["Tables"]["channel_events"]["Insert"]>;
				Relationships: [];
			};
		};
