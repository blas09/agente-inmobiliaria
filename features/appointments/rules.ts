...
export const appointmentRulesSchema = z.object({
	...
	working_days: z.array(workingDaySchema).min(1, "Seleccioná al menos un día hábil."),
});
...
export function getAppointmentRules(settings: Json | null | undefined): AppointmentRules {
...
export function validateAppointmentLocalDateTime(localValue: string, rules: AppointmentRules) {
